...
const FeatureCard = ({
    title,desc,icon,delay=0
})=>{
    return <div className={featuresStyles.featureCard} style={{
       ...
       <div className={featuresStyles.container}>
        <div className={featuresStyles.headerContainer}>
            ...
            <p className={featuresStyles.subtitle}>
                Experience the future of invoicing with our AI-powered platform that transforms freeform text into perfectly formatted invoices, generates professional email reminders, and delivers high-quality PDF exports with ease.
            </p>
        </div>
