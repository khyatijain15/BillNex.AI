...
const Pricing = () => {
  ...
  function handleCtsClick(planMeta,flags={}){
    ...
    navigate("/app/create-invoice",{
        state:{fromPlane :planMeta?.title || null},
    })
  }
    ...
    <section id='pricing' className={pricingStyles.section}>
        ...
        <div className={pricingStyles.container}>
            <div className={pricingStyles.headerContainer}>
                ...
                <p className={pricingStyles.description}>Start free, upgrade as you grow. No hidden fees, no surprise charges.</p>
