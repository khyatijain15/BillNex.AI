...
//func to fetch image coming from server side
...
const BusinessProfile = () => {
  ...
  //func to fetch user's business profile if saved previously
    useEffect(() => {
    let mounted = true;
...
function handleLocalFilePick(kind, file) {
  ...
  //we can remove preview file by this function if we want to change or remove it
  ...
  //to save or update business profile in the DB
    ...
    <div className={businessProfileStyles.pageContainer}>
        <div className={businessProfileStyles.headerContainer}>
            ...
            {!isSignedIn && (
                ...
                You are not signed in - changes can not be saved. Please sign in to load
                and save your business profile.</div>
            )}
        </div>
                  ...
                  <div className='flex items-center gap-3'>
                    ...
                    <span className={customStyles.taxPercentage}>%</span>
                      ...
                      <p className={businessProfileStyles.taxHelpText}> 
                        This tax percentage will be pre-applied to all invoice items by default, but you can adjust it for each item when creating an invoice.
                      </p>
                </div>
            </div>
          </div>
