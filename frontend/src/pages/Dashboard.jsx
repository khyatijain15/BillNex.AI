...
//small helpers- convert values into uppercase
...
//1usd=inr
  ...
  //KPI computation with percentages ie(convert each invoices into inr before summarizing)
  const kpis = useMemo(() => {
  ...
  //recent invoices sorted by created at date in db
  ...
  //to fetch client name from invoice object
  ...
  //to get first letter of client name for avatar
    ...
    <div className={dashboardStyles.pageContainer}>
      <div className={dashboardStyles.headerContainer}>
        ...
        <p className={dashboardStyles.headerSubtitle}>
          Welcome back! Here's a summary of your recent activity and key metrics.
        </p>
      </div>
       ...
       {loading ? (
        ...
        <div className='p-6'>
          ...
          <div className='flex gap-2'>
            <button onClick={fetchInvoices} className='px-3 py-1 bg-blue-600 text-white roundes'>
                 Retry
            </button>
          ...
          <div className='space-y-3'>
            ...
            <div className={dashboardStyles.quickStatsRow}>
              ...
              <span className={dashboardStyles.quickStatsValue}>
                {currencyFmt(
                  kpis.totalInvoices > 0 
                  ? (kpis.totalPaid + kpis.totalInvoices) / kpis.totalInvoices
                  : 0,
                  "INR"
                )}
              </span>
              ...
              <div className={dashboardStyles.tableHeaderContent}>
                <div>
                  ...
                  <p className={dashboardStyles.tableSubtitle}>
                    Latest 5 invoices based on issue date. Click to view details.
                  </p>
                </div>
                <button
                onClick={()=>navigate("/app/invoices")} 
