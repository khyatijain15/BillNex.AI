...
//to parse formData as items
 ...
 //check if the string is an Object ID 
...
//to generate unique no to avoid collision in DB for invoice no
...
export async function updateInvoice(req,res) {
    try {
     ...
     //if user changes the invoice no
     //ensure that it doesnt exist already or not in use
